...
def calculate_lcr_cost(rates, n):
    ...
    return rates[min(n-1, len(rates)-1)] if rates else 0.0
...
st.title("Telecall - CSV Rate Aggregator v12.0")
...
if st.button("Execute"):
    ...
    st.download_button("Download Main LCR Results as CSV", data=csv_main, file_name='main_lcr_results.csv', mime='text/csv')
    ...
    st.download_button("Download High-Rate Prefixes as CSV", data=csv_high_rates, file_name='high_rate_prefixes.csv', mime='text/csv')
